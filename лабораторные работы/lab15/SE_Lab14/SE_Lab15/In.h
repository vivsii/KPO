...
namespace In
{
	...
	struct IN
	{
		...
		int code[256] =
		{
			  IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, IN::T, IN::F,   '|', IN::F, IN::F, IN::F, IN::F, IN::F, // 0
			  ...
			  IN::F, IN::F, IN::F, IN::F, IN::F, IN::T, IN::F, IN::F, IN::F, IN::F, IN::F, IN::T, IN::F, IN::F, IN::T, IN::T, // 64
